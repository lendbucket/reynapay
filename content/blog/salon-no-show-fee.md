---
title: "No-show fees: How to charge them, automate them, and not get chargebacks"
slug: "salon-no-show-fee"
excerpt: "No-show fees are how salons stop bleeding revenue from empty chairs. But charging them wrong creates chargebacks, bad reviews, and lost customers. Here's how to do it right."
date: "2026-04-15"
category: "product"
author: "Robert Reyna"
...
**Card-on-file or pre-authorization at booking.** You can't charge a fee if you can't reach the card. Either the customer puts a card on file when booking, or the booking system pre-authorizes a card (a small hold, like $1) that becomes the charge target if a no-show occurs. See our post on [card-on-file at the salon](/blog/salon-card-on-file) for the legal and technical details.
...
If you want to introduce no-show fees and don't want to manage the technical and legal infrastructure yourself, [apply to SalonTransact](/apply) or [talk to our team](/contact). We'll walk you through the rollout sequence we've tested at our own salons.
