...
export const INDUSTRY_CONTENT: Record<string, IndustryContent> = {
  salons: {
    ...
    outcomes: {
      ...
      description: "Real numbers from salons running SalonTransact, our salon-specific platform built on Reyna Pay's processing rails.",
      stats: [
        { value: "$8,400", label: "Average annual savings on a $40K/month salon" },
        { value: "73%", label: "Reduction in payday reconciliation time" },
        { value: "$11K+", label: "Recovered no-show revenue per location, year one" },
    ...
    useCases: [
      ...
      },
      {
        ...
        description: "8 stylists on commission, one front desk. Pay periods close in minutes. Stylists see their own earnings in real time. No commission disputes.",
      },
      {
  ...
  barbershops: {
    ...
    outcomes: {
      ...
      description: "Numbers from real multi-chair barbershops on SalonTransact.",
      stats: [
        { value: "<15 sec", label: "Average checkout time for regulars" },
        { value: "$5,200", label: "Annual savings on a 6-chair shop at $25K/month" },
        { value: "0", label: "Commission disputes — math is auto-attributed" },
        { value: "100%", label: "Booth renters keep their service revenue, cleanly separated" },
      ],
    },
    whyUs: {
      title: "Barbershops aren't salons. The processor shouldn't pretend they are.",
      description:
    ...
    useCases: [
      {
        ...
        description: "One chair, walk-ins, tips. Lowest tier pricing, no monthly minimums. Scale as you grow without switching processors.",
      },
      {
        title: "Multi-chair shop with employees",
        description: "5-10 W-2 barbers. Commission tracking, tip pools, and walk-in optimization. Payday closes itself.",
      },
      {
      ...
      },
      {
        ...
        description: "Mixed staffing, mixed payouts. Each barber configured independently. No spreadsheet hell at month-end.",
      },
      {
        title: "Multi-location franchise group",
        description: "Three to twenty shops. Separate MIDs per location. Roll-up reporting. Compare shops on every metric that matters.",
      },
      {
    ...
    testimonial: {
      quote: "Three of my barbers rent chairs and three are on commission. Square couldn't tell us apart. Reyna Pay solved it in one setup call.",
      name: "Shop Owner",
      role: "Owner",
  ...
  "med-spas": {
    ...
    problem: {
      title: "If you've been declined or had funds held by your processor — that's not your fault.",
    ...
    outcomes: {
      ...
      description: "Real outcomes from med spas running on Reyna Pay's processing platform.",
      stats: [
        { value: "2.4-2.7%", label: "Typical effective rate on $50K+/month volume" },
        { value: "0", label: "Holds on legitimate high-ticket transactions" },
        { value: "$18K+", label: "Recovered annually vs. high-risk classification" },
        { value: "92%", label: "Approval rate for med spas other processors decline" },
      ],
    },
    whyUs: {
    ...
    useCases: [
      ...
      },
      {
        ...
        description: "RNs, aestheticians, laser techs all under one roof. Provider commission tracking. Service-category reporting.",
      },
      {
  ...
  "tattoo-studios": {
    ...
    outcomes: {
      ...
      description: "Real outcomes from tattoo studios processing on our platform.",
      stats: [
        { value: "Standard", label: "MCC classification — not high-risk" },
        { value: "78%", label: "Chargeback win rate with auto-built evidence packs" },
        { value: "100%", label: "Booking deposits tracked against final invoice" },
    ...
    useCases: [
      {
        ...
        description: "One artist, deposit-required appointments. Each booking pre-authorized at the booking deposit amount. Final captures at appointment.",
      },
      {
        title: "Multi-artist shop with employees",
        description: "Shop owns the chairs, artists are W-2. Commission tracking, tip pools, and unified reporting per shop.",
      },
      {
  ...
  "nail-salons": {
    ...
    problem: {
      title: "Your nail salon isn't a coffee shop. Stop running it on a coffee-shop POS.",
    ...
    outcomes: {
      ...
      description: "Real outcomes from nail salons running on our SalonTransact platform.",
      stats: [
        { value: "<15 sec", label: "Walk-in checkout for regulars on card-on-file" },
        { value: "100%", label: "Tech commission attribution — automated" },
        { value: "Tracked", label: "Gift card balances and package liabilities" },
        { value: "$3,800+", label: "Average annual savings on a $20K/month salon" },
      ],
    },
    whyUs: {
    ...
    useCases: [
      ...
      },
      {
        ...
        description: "10+ techs on commission. Auto-attribution, payday in minutes, retail commission tracked separately.",
      },
      {
  ...
  "lash-and-brow": {
    ...
    problem: {
      title: "Your business is recurring revenue. Why is your processor treating it like retail?",
    ...
    outcomes: {
      ...
      description: "Real numbers from lash studios on our SalonTransact platform.",
      stats: [
        { value: "92%", label: "Recovered failed payments via smart retry logic" },
        { value: "Tracked", label: "Fill cadence per customer — automated outreach" },
        { value: "100%", label: "Bundle balance tracking with renewal pitches" },
    ...
    useCases: [
      {
        ...
        description: "One artist, room rental setup. Membership program for repeat clients. Card-on-file for the bundle crowd.",
      },
      {
        title: "Multi-tech lash studio",
        description: "5-10 lash and brow techs. Junior vs. senior rate tiers. Tech commission attribution per service.",
      },
      {
        title: "Membership-driven model",
        description:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: "Yes. Configure tip suggestions or percent-based prompts. Disable for very small transactions if you prefer.",
      },
      {
