...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Vertical-specific payment processing. SalonTransact, KasseApp, RunMySalon, and a partner network, on one transparent infrastructure.",
    images: [
      { url: "/og/default.png", width: 1200, height: 630, alt: "Reyna Pay" },
    ],
  },
  twitter: {
    ...
    description:
      "Vertical-specific payment processing for salons, restaurants, gyms, retail, and more.",
