...
export const metadata = buildMetadata({
  ...
  description:
    "Reyna Pay serves salons, restaurants, gyms, retail, professional services, and dozens more industries with vertical-specific payment processing infrastructure.",
  path: "/who-we-serve",
});
...
export default function WhoWeServePage() {
  ...
  return (
    <>
      ...
      <HeroSection
        eyebrow="Industries"
        headline={<>Built for the industries <span className="text-[var(--color-brand)]">the giants ignore.</span></>}
              ...
              >
                <div>
                  ...
                  <p className="text-sm text-[var(--color-ink-muted)] leading-relaxed">
                    Payment processing built for {ind.name.toLowerCase()}.
                  </p>
                </div>
